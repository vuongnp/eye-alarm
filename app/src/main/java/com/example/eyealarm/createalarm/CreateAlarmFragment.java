...
public class CreateAlarmFragment extends Fragment {
    ...
    EditText title;
    @BindView(R.id.fragment_createalarm_back)
    Button backToAlarmsList;
    @BindView(R.id.fragment_createalarm_addAlarm)
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        backToAlarmsList.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.action_createAlarmFragment_to_alarmsListFragment);
            }
